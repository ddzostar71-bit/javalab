...
> **📋 УСТАНОВКА:** Перед началом работы ознакомьтесь с инструкцией по установке:
> - **[Инструкция для Windows](INSTALLATION_WINDOWS.md)** - пошаговое руководство для Windows
> - **[Инструкция для всех платформ](INSTALLATION.md)** - для Windows, Linux и macOS
