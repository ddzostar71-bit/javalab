...
> **📋 ВАЖНО:** Перед началом работы ознакомьтесь с инструкцией по установке:
> - **[Инструкция для Windows](INSTALLATION_WINDOWS.md)** - пошаговое руководство с картинками для Windows
